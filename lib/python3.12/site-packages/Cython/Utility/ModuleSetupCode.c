...
#else
  #define __Pyx_IS_TYPE(ob, type) (Py_TYPE(((const PyObject*)ob)) == (type))
#endif
...
#if CYTHON_COMPILING_IN_CPYTHON
#define __Pyx_CyOrPyCFunction_GET_FUNCTION(func)  (GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)(func))))->ml_meth)
...
#endif
#if CYTHON_COMPILING_IN_CPYTHON
#define __Pyx_CyOrPyCFunction_GET_FLAGS(func)  (GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)(func))))->ml_flags)
