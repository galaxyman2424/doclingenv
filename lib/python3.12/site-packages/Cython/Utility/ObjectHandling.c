...
__Pyx_PyTuple_FromArray(PyObject *const *src, Py_ssize_t n)
{
    ...
    __Pyx_copy_object_array(src, PySequence_Fast_ITEMS((PyObject*)((PyTupleObject*)res)), n);
    return res;
}
...
__Pyx_PyList_FromArray(PyObject *const *src, Py_ssize_t n)
{
    ...
    res = PyList_New(n);
    if (unlikely(res == NULL)) return NULL;
    __Pyx_copy_object_array(src, PySequence_Fast_ITEMS((PyObject*)((PyListObject*)res)), n);
    return res;
}
#endif
...
{{endif}}
    return __Pyx_Py{{type}}_FromArray(PySequence_Fast_ITEMS((PyObject*)((Py{{type}}Object*)src)) + start, length);
}
{{endfor}}
#endif
...
static PyObject *__Pyx_PyFunction_FastCallDict(PyObject *func, PyObject **args, Py_ssize_t nargs, PyObject *kwargs) {
    ...
    if (
        ...
        if (argdefs == NULL && co->co_argcount == nargs) {
            ...
            args = PySequence_Fast_ITEMS(argdefs);
    ...
    if (kwargs != NULL) {
        ...
        k = PySequence_Fast_ITEMS(kwtuple);
        pos = i = 0;
    ...
    if (argdefs != NULL) {
        d = PySequence_Fast_ITEMS(argdefs);
        nd = Py_SIZE(argdefs);
    }
    else {
        d = NULL;
