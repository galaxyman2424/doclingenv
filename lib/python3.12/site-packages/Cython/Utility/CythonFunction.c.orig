...
#else
        if (GraalPyCFunction_GetDoc((PyObject*)(((PyCFunctionObject*)op)))) {
#if PY_MAJOR_VERSION >= 3
            op->func_doc = PyUnicode_FromString(GraalPyCFunction_GetDoc((PyObject*)(((PyCFunctionObject*)op))));
#else
            op->func_doc = PyString_FromString(GraalPyCFunction_GetDoc((PyObject*)(((PyCFunctionObject*)op))));
#endif
            if (unlikely(op->func_doc == NULL))
                return NULL;
        } else {
...
__Pyx_CyFunction_get_name(__pyx_CyFunctionObject *op, void *context)
{
    ...
    if (unlikely(op->func_name == NULL)) {
        ...
        op->func_name = PyUnicode_InternFromString(GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)op)))->ml_name);
#else
        op->func_name = PyString_InternFromString(GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)op)))->ml_name);
#endif  /* CYTHON_COMPILING_IN_LIMITED_API */
        if (unlikely(op->func_name == NULL))
            return NULL;
    }
...
#else
    return PyString_FromString(GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)m)))->ml_name);
#endif
}
...
#if !CYTHON_COMPILING_IN_LIMITED_API
    GraalPyCFunction_SetMethodDef((PyObject*)(cf), ml);
...
#if !CYTHON_COMPILING_IN_LIMITED_API
    Py_XINCREF(module);
    GraalPyCFunction_SetModule((PyObject*)(cf), module);
#endif
    op->func_dict = NULL;
    op->func_name = NULL;
    Py_INCREF(qualname);
...
static PyObject * __Pyx_CyFunction_CallMethod(PyObject *func, PyObject *self, PyObject *arg, PyObject *kw) {
    ...
    PyCFunction meth = GraalPyCFunction_GetMethodDef((PyObject*)(f))->ml_meth;
    int flags = GraalPyCFunction_GetMethodDef((PyObject*)(f))->ml_flags;
#endif
    ...
    case METH_NOARGS:
        if (likely(kw == NULL || PyDict_Size(kw) == 0)) {
            ...
            PyErr_Format(PyExc_TypeError,
                "%.200s() takes no arguments (%" CYTHON_FORMAT_SSIZE_T "d given)",
                GraalPyCFunction_GetMethodDef((PyObject*)(f))->ml_name, size);
#endif
            return NULL;
        }
        break;
...
static PyObject *__Pyx_CyFunction_CallAsMethod(PyObject *func, PyObject *args, PyObject *kw) {
    ...
    if (vc) {
#if CYTHON_ASSUME_SAFE_MACROS
        return __Pyx_PyVectorcall_FastCallDict(func, vc, PySequence_Fast_ITEMS(args), (size_t)PyTuple_GET_SIZE(args), kw);
#else
...
static CYTHON_INLINE int __Pyx_CyFunction_Vectorcall_CheckArgs(__pyx_CyFunctionObject *cyfunc, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if ((cyfunc->flags & __Pyx_CYFUNCTION_CCLASS) && !(cyfunc->flags & __Pyx_CYFUNCTION_STATICMETHOD)) {
        if (unlikely(nargs < 1)) {
            PyErr_Format(PyExc_TypeError, "%.200s() needs an argument",
                         GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)cyfunc)))->ml_name);
            return -1;
        }
        ret = 1;
    }
    if (unlikely(kwnames) && unlikely(PyTuple_GET_SIZE(kwnames))) {
        PyErr_Format(PyExc_TypeError,
                     "%.200s() takes no keyword arguments", GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)cyfunc)))->ml_name);
        return -1;
    }
    return ret;
}
...
{
    __pyx_CyFunctionObject *cyfunc = (__pyx_CyFunctionObject *)func;
    PyMethodDef* def = GraalPyCFunction_GetMethodDef((PyObject*)(((PyCFunctionObject*)cyfunc)));
#if CYTHON_BACKPORT_VECTORCALL
...
__pyx_FusedFunction_descr_get(PyObject *self, PyObject *obj, PyObject *type)
{
    ...
    meth = (__pyx_FusedFunctionObject *) __pyx_FusedFunction_New(
                    ...
                    GraalPyCFunction_GetModule((PyObject*)(((PyCFunctionObject *) func))),
