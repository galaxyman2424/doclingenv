...
CONFIG = _cleanup(
    {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": r"USE_64BITINT= DYNAMIC_ARCH=1 DYNAMIC_OLDER= NO_CBLAS= NO_LAPACK= NO_LAPACKE= NO_AFFINITY=1 USE_OPENMP=0 PRESCOTT MAX_THREADS=64",
        ...
        "Python Information": {
            "path": r"/workdir/install-virtualenv/bin/graalpy",
            "version": "3.12",
        },
        "SIMD Extensions": {
