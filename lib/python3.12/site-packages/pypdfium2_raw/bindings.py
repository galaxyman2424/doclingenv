...
# ./fpdfview.h: 84
FPDF_SKIA_CANVAS = None  # patched for GraalPy
...
FPDF_LoadMemDocument.argtypes = [c_void_p, c_int, FPDF_BYTESTRING]
FPDF_LoadMemDocument.restype = FPDF_DOCUMENT

# ./fpdfview.h: 438
FPDF_LoadMemDocument64 = _libs['pdfium']['FPDF_LoadMemDocument64']
FPDF_LoadMemDocument64.argtypes = [c_void_p, c_size_t, FPDF_BYTESTRING]
...
struct_anon_4._fields_ = [
    ('m_FileLen', c_ulong),
    ('m_GetBlock', CFUNCTYPE(c_int, c_void_p, c_ulong, POINTER(c_ubyte), c_ulong)),
    ('m_Param', c_void_p),
]
...
struct_FPDF_FILEHANDLER_._fields_ = [
    ...
    ('GetSize', CFUNCTYPE(FPDF_DWORD, c_void_p)),
    ('ReadBlock', CFUNCTYPE(FPDF_RESULT, c_void_p, FPDF_DWORD, c_void_p, FPDF_DWORD)),
    ('WriteBlock', CFUNCTYPE(FPDF_RESULT, c_void_p, FPDF_DWORD, c_void_p, FPDF_DWORD)),
    ('Flush', CFUNCTYPE(FPDF_RESULT, c_void_p)),
    ('Truncate', CFUNCTYPE(FPDF_RESULT, c_void_p, FPDF_DWORD)),
]
...
FPDFBitmap_CreateEx.argtypes = [c_int, c_int, c_int, c_void_p, c_int]
...
FPDFBitmap_GetBuffer.restype = c_void_p
...
FPDF_GetNamedDest.argtypes = [FPDF_DOCUMENT, c_int, c_void_p, POINTER(c_long)]
...
FPDF_GetXFAPacketName.argtypes = [FPDF_DOCUMENT, c_int, c_void_p, c_ulong]
FPDF_GetXFAPacketName.restype = c_ulong

# ./fpdfview.h: 1423
FPDF_GetXFAPacketContent = _libs['pdfium']['FPDF_GetXFAPacketContent']
FPDF_GetXFAPacketContent.argtypes = [FPDF_DOCUMENT, c_int, c_void_p, c_ulong, POINTER(c_ulong)]
...
struct__IPDF_JsPlatform._fields_ = [
    ...
    ('app_response', CFUNCTYPE(c_int, POINTER(struct__IPDF_JsPlatform), FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_BOOL, c_void_p, c_int)),
    ('Doc_getFilePath', CFUNCTYPE(c_int, POINTER(struct__IPDF_JsPlatform), c_void_p, c_int)),
    ('Doc_mail', CFUNCTYPE(None, POINTER(struct__IPDF_JsPlatform), c_void_p, c_int, FPDF_BOOL, FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_WIDESTRING, FPDF_WIDESTRING)),
    ...
    ('Doc_submitForm', CFUNCTYPE(None, POINTER(struct__IPDF_JsPlatform), c_void_p, c_int, FPDF_WIDESTRING)),
    ('Doc_gotoPage', CFUNCTYPE(None, POINTER(struct__IPDF_JsPlatform), c_int)),
    ('Field_browse', CFUNCTYPE(c_int, POINTER(struct__IPDF_JsPlatform), c_void_p, c_int)),
    ('m_pFormfillinfo', c_void_p),
    ('m_isolate', c_void_p),
    ('m_v8EmbedderSlot', c_uint),
]
...
struct__FPDF_FORMFILLINFO._fields_ = [
    ...
    ('FFI_GetPlatform', CFUNCTYPE(c_int, POINTER(struct__FPDF_FORMFILLINFO), c_void_p, c_int)),
    ('FFI_GetLanguage', CFUNCTYPE(c_int, POINTER(struct__FPDF_FORMFILLINFO), c_void_p, c_int)),
...
FORM_GetFocusedText.argtypes = [FPDF_FORMHANDLE, FPDF_PAGE, c_void_p, c_ulong]
FORM_GetFocusedText.restype = c_ulong

# ./fpdf_formfill.h: 1557
FORM_GetSelectedText = _libs['pdfium']['FORM_GetSelectedText']
FORM_GetSelectedText.argtypes = [FPDF_FORMHANDLE, FPDF_PAGE, c_void_p, c_ulong]
...
FPDFAttachment_SetFile.argtypes = [FPDF_ATTACHMENT, FPDF_DOCUMENT, c_void_p, c_ulong]
FPDFAttachment_SetFile.restype = FPDF_BOOL

# ./fpdf_attachment.h: 170
FPDFAttachment_GetFile = _libs['pdfium']['FPDFAttachment_GetFile']
FPDFAttachment_GetFile.argtypes = [FPDF_ATTACHMENT, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDFBookmark_GetTitle.argtypes = [FPDF_BOOKMARK, c_void_p, c_ulong]
...
FPDFAction_GetFilePath.argtypes = [FPDF_ACTION, c_void_p, c_ulong]
FPDFAction_GetFilePath.restype = c_ulong

# ./fpdf_doc.h: 207
FPDFAction_GetURIPath = _libs['pdfium']['FPDFAction_GetURIPath']
FPDFAction_GetURIPath.argtypes = [FPDF_DOCUMENT, FPDF_ACTION, c_void_p, c_ulong]
...
FPDF_GetFileIdentifier.argtypes = [FPDF_DOCUMENT, FPDF_FILEIDTYPE, c_void_p, c_ulong]
FPDF_GetFileIdentifier.restype = c_ulong

# ./fpdf_doc.h: 411
FPDF_GetMetaText = _libs['pdfium']['FPDF_GetMetaText']
FPDF_GetMetaText.argtypes = [FPDF_DOCUMENT, FPDF_BYTESTRING, c_void_p, c_ulong]
FPDF_GetMetaText.restype = c_ulong

# ./fpdf_doc.h: 429
FPDF_GetPageLabel = _libs['pdfium']['FPDF_GetPageLabel']
FPDF_GetPageLabel.argtypes = [FPDF_DOCUMENT, c_int, c_void_p, c_ulong]
...
FPDFPageObjMark_GetName.argtypes = [FPDF_PAGEOBJECTMARK, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDFPageObjMark_GetParamKey.argtypes = [FPDF_PAGEOBJECTMARK, c_ulong, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDFPageObjMark_GetParamStringValue.argtypes = [FPDF_PAGEOBJECTMARK, FPDF_BYTESTRING, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDFPageObjMark_GetParamBlobValue.argtypes = [FPDF_PAGEOBJECTMARK, FPDF_BYTESTRING, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDFPageObjMark_SetBlobParam.argtypes = [FPDF_DOCUMENT, FPDF_PAGEOBJECT, FPDF_PAGEOBJECTMARK, FPDF_BYTESTRING, c_void_p, c_ulong]
...
FPDFImageObj_GetImageDataDecoded.argtypes = [FPDF_PAGEOBJECT, c_void_p, c_ulong]
FPDFImageObj_GetImageDataDecoded.restype = c_ulong

# ./fpdf_edit.h: 726
FPDFImageObj_GetImageDataRaw = _libs['pdfium']['FPDFImageObj_GetImageDataRaw']
FPDFImageObj_GetImageDataRaw.argtypes = [FPDF_PAGEOBJECT, c_void_p, c_ulong]
...
FPDFImageObj_GetImageFilter.argtypes = [FPDF_PAGEOBJECT, c_int, c_void_p, c_ulong]
...
struct_FPDF_FILEWRITE_._fields_ = [
    ('version', c_int),
    ('WriteBlock', CFUNCTYPE(c_int, POINTER(struct_FPDF_FILEWRITE_), c_void_p, c_ulong)),
]
...
FPDFSignatureObj_GetContents.argtypes = [FPDF_SIGNATURE, c_void_p, c_ulong]
...
FPDFSignatureObj_GetReason.argtypes = [FPDF_SIGNATURE, c_void_p, c_ulong]
...
FPDF_StructElement_GetAltText.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetActualText.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetID.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetLang.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetStringAttribute.argtypes = [FPDF_STRUCTELEMENT, FPDF_BYTESTRING, c_void_p, c_ulong]
...
FPDF_StructElement_GetType.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetObjType.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_GetTitle.argtypes = [FPDF_STRUCTELEMENT, c_void_p, c_ulong]
...
FPDF_StructElement_Attr_GetName.argtypes = [FPDF_STRUCTELEMENT_ATTR, c_int, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDF_StructElement_Attr_GetStringValue.argtypes = [FPDF_STRUCTELEMENT_ATTR, FPDF_BYTESTRING, c_void_p, c_ulong, POINTER(c_ulong)]
...
FPDF_StructElement_Attr_GetBlobValue.argtypes = [FPDF_STRUCTELEMENT_ATTR, FPDF_BYTESTRING, c_void_p, c_ulong, POINTER(c_ulong)]
...
struct__FPDF_SYSFONTINFO._fields_ = [
    ...
    ('EnumFonts', CFUNCTYPE(None, POINTER(struct__FPDF_SYSFONTINFO), c_void_p)),
    ('MapFont', CFUNCTYPE(c_void_p, POINTER(struct__FPDF_SYSFONTINFO), c_int, FPDF_BOOL, c_int, c_int, POINTER(c_char), POINTER(FPDF_BOOL))),
    ('GetFont', CFUNCTYPE(c_void_p, POINTER(struct__FPDF_SYSFONTINFO), POINTER(c_char))),
    ('GetFontData', CFUNCTYPE(c_ulong, POINTER(struct__FPDF_SYSFONTINFO), c_void_p, c_uint, POINTER(c_ubyte), c_ulong)),
    ('GetFaceName', CFUNCTYPE(c_ulong, POINTER(struct__FPDF_SYSFONTINFO), c_void_p, POINTER(c_char), c_ulong)),
    ('GetFontCharset', CFUNCTYPE(c_int, POINTER(struct__FPDF_SYSFONTINFO), c_void_p)),
    ('DeleteFont', CFUNCTYPE(None, POINTER(struct__FPDF_SYSFONTINFO), c_void_p)),
]
...
FPDF_AddInstalledFont.argtypes = [c_void_p, POINTER(c_char), c_int]
...
FPDFText_GetFontInfo.argtypes = [FPDF_TEXTPAGE, c_int, c_void_p, c_ulong, POINTER(c_int)]
...
FPDFPage_GetDecodedThumbnailData.argtypes = [FPDF_PAGE, c_void_p, c_ulong]
FPDFPage_GetDecodedThumbnailData.restype = c_ulong

# ./fpdf_thumbnail.h: 43
FPDFPage_GetRawThumbnailData = _libs['pdfium']['FPDFPage_GetRawThumbnailData']
FPDFPage_GetRawThumbnailData.argtypes = [FPDF_PAGE, c_void_p, c_ulong]
